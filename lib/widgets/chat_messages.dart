  ...
  final loadedMessages = chatSnapshots.data!.docs;
        return ListView.builder(
          ...
          itemBuilder: (ctx,index){
            ...
            if(nextUserIsSame){
              return MessageBubble.next(message: chatMessage['text'], isMe: authenticatedUser!.uid == currentMessageUsernameId);
            }
            else{
              return MessageBubble.first(userImage: chatMessage['userImage'], username: chatMessage['username'], message: chatMessage['text'], isMe: authenticatedUser!.uid == currentMessageUsernameId);
            }
        });
    });
  }
